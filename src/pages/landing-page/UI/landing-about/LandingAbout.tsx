...
import crossedHammersImg from '/imgs/webp/crossed-hammers.webp';
import { LandingTitle } from '@landing/UI/landing-title/LandingTitle';
import { AboutSectionConfig } from '@landing/page-config/landing.config';
import { LandingContainer } from '@landing/UI/landing-container/LandingContainer';
import { LandingParagraph } from '@landing/UI/landing-paragraph/LandingParagraph';
			...
			<MaxWidthContainer>
				<LandingContainer>
					<LandingTitle text={title} classNames={{ blur: 'md:w-1/4 md:blur-[90px]' }}>
						<ImageComp
							className="w-22 md:w-24 lg:w-26 xl:w-30 h-22 md:h-24 lg:h-26 xl:h-30 mt-2 md:mt-4 lg:mt-5 xl:mt-6"
